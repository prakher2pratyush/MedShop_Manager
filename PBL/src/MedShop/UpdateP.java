...
public class UpdateP extends javax.swing.JFrame 
{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            String query1 = "UPDATE `pharmacist` SET `Cont_no`= "+mfg+" WHERE `Phar_id` = '"+id+"'";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        {
            String query1 = "UPDATE `pharmacist` SET `address`= "+mfg+" WHERE `Phar_id` = '"+id+"'";
            st.executeUpdate(query1);
            JOptionPane.showMessageDialog(null,"Successfuly Updated");
            jTextField1.setText("");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try
        {
            String query1 = "UPDATE `pharmacist` SET `Phar_name`= '"+name+"' WHERE `Phar_id` = '"+id+"'";
            st.executeUpdate(query1);
            JOptionPane.showMessageDialog(null,"Successfuly Updated");
            jTextField1.setText("");
            jTextField2.setText("Name");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try
        {
            String query1 = "UPDATE `pharmacist` SET `Phar_pin`= '"+mfg+"' WHERE `Phar_id` = '"+id+"'";
            st.executeUpdate(query1);
            JOptionPane.showMessageDialog(null,"Successfuly Updated");
            jTextField1.setText("");
            jTextField3.setText("Pin");
