...
public class Apharmacist extends javax.swing.JFrame 
{
       	...
       	catch(ClassNotFoundException | SQLException e)
	{
        ...
        try
        {
            String query1 = "select * From pharmacist";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        {
            String query1 = "delete From pharmacist where Phar_id = "+id;
            st.executeUpdate(query1);
            try
            {
                String query2 = "select * From pharmacist";
    ...
    public static void main(String args[]) 
    {
        java.awt.EventQueue.invokeLater(() -> {
            new Apharmacist().setVisible(true);
        });
    }
